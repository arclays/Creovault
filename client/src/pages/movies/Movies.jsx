  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b bg-neutral-800">
      <main className="flex-grow">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center">
              <input
                ...
                className="w-4/5 sm:w-1/2 px-4 py-2 rounded bg-neutral-700 text-white border-2 border-transparent focus:outline-none focus:ring-2 focus:ring-red-600 mb-4 sm:mb-0"
              />
        ...
        {/* Responsive Grid for Movie Sliders */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 container mx-auto px-5 md:px-20 gap-7 py-10">
